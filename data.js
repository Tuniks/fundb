export default data = {
    ...
    places:[
        ...
        {key:2,
            ...
            reviews:[
                {key:0, namerev: 'joao', review: 'festa só tinha nerdão'},
                {key:1, namerev: 'vendedor', review: '8 CONTO SKOL BEATS NA MINHA MÃO'},
            ]
        },
    ],
    ...
    teachers:[
        {key:0,
            name:'Henrique Cookie',
            img:require('./img/cookie.jpg'),
            rating:[1,5],
        },
        {key:1,
            name:'Braffman',
            img:require('./img/ci.jpg'),
            rating:[2,4],
        },
        {key:2,
            name:'Abraão',
