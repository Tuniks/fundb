export default data = {
    restaurants:[
        ...
        {key:1, name:'Yakuza', rating:[3,3], type:[true,false,false,true,true], img:require('./img/yakuza.jpg'),
            reviews:[
                {key:0, namerev:'formiga', review:'adoro gente sério mto bom'},
                {key:1, namerev:'kojima', review: '私はそれがとても好き'}]
        },
        {key:2, name:'Kanye', rating:[1,5], type:[true,true,true,true,true], img:require('./img/kanye.jpg'),
            reviews:[
